	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
            ...
            <div class="x_content" style="display: block;">
                <form action="{{route('companies/update')}}" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input value="{{$company['id']}}" type="hidden" id="id" name="id" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="description" name="description" required="required" class="form-control col-md-7 col-xs-12">{{$company['description']}}</textarea value="{{$company['name']}}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="{{$company['category']}}" type="text" id="category" name="category" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="address" name="address"  class="form-control col-md-7 col-xs-12">{{$company['address']}}</textarea value="{{$company['name']}}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="{{$company['address_url']}}" type="text" id="address_url" name="address_url"  class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="{{$company['website']}}" type="text" id="website" name="website"  class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="{{$company['linkedin']}}" type="text" id="linkedin" name="linkedin" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="{{$company['instagram']}}" type="text" id="instagram" name="instagram" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="{{$company['facebook']}}" type="text" id="facebook" name="facebook" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="{{$company['twitter']}}" type="text" id="twitter" name="twitter" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="{{$company['youtube']}}" type="text" id="youtube" name="youtube" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="{{$company['key_person_name']}}" type="text" id="keyPersonName" name="keyPersonName" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="{{$company['key_person_title']}}" type="text" id="keyPersonTitle" name="keyPersonTitle" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select id="adminUserId" name="adminUserId" required="required" class="form-control col-md-7 col-xs-12">
                                @foreach($adminUsers as $adminUser)
                                    <option @if($adminUser['id'] == $company['admin_user_id']) selected @endif value="{{ $adminUser['id'] }}">{{ $adminUser['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
